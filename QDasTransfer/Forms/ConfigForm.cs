...
namespace QDasTransfer.Forms
{
	public partial class ConfigForm : Form
	{
		...
		private void ConfigForm_Load(object sender, EventArgs e)
		{
			...
			{
				ckKeepFolderStruct.Checked = true;
				numlblKeepFolderLevel.Value = pd.OriginalLevelKept;
				numlblKeepFolderLevel.Enabled = true;
			}
			else
			{
				ckKeepFolderStruct.Checked = false;
			}
		...
		private void btnSave_Click(object sender, EventArgs e)
		{
			...
			if (ckKeepFolderStruct.Checked)
				pd.OriginalLevelKept = (int)numlblKeepFolderLevel.Value;
			else
				pd.OriginalLevelKept = 0;
		...
		{
			numlblKeepFolderLevel.Enabled = ckKeepFolderStruct.Checked;
		}
